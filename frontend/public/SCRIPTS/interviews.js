...
.then(data => {
    ...
    if (isFirstTime) {
        ...
        `
        <div class="deskshow custcectitle detailbrdcrumb cmndcrumb">
        <h2><span class=""><a href="/" class="">A la une sur <span style="color: red;">•</span> INFOBTP </a></h2>
        </div>
        ...
        `
            <div class="featured-video">
                ...
                <div class="video-info">
                    ...
                    <p>Date de publication: ${convertionDate(lastVideoAdd.publicationDate)}</p>
                </div>
            </div>
        `
        ...
        `
            <div class="video-item " interviewTitle = ${item.title} interviewCategory = ${item.category} interviewDate = ${item.publicationDate} interviewPresenter = ${item.presenter} interviewVideoUrl = ${item.videoUrl}>
                ...
                <div class="video-info">
                    ...
                    <p>Date de publication: ${convertionDate(item.publicationDate)}</p>
                </div>
            </div>
        `
