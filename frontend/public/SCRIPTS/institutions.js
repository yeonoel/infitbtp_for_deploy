    ...
    .then(data => {
            ...
            <div class="trending-top mb-30 article-item" data-article-id="${element._id}">
                <div class="trend-top-img">
                    ...
                    <div class="trend-top-cap">
                        ...
                        <p data-animation="fadeInUp" data-delay=".6s" data-duration="1000ms">par ${element.auteur}   -   ${element.datePublication}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="trending-top mb-30 article-item " data-article-id="${element._id}">
                <div class="trend-top-img">
                    ...
                    <div class="trend-top-cap trend-top-cap2">
                        ...
                        <p>par ${element.auteur}    -   ${element.datePublication}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        articleItem.forEach(item => {
            item.addEventListener('click', () => {
                ...
                window.location.href = `latest_institutions.html?id=${articleId}`;
            })
