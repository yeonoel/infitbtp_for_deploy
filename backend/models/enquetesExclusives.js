...
const enquetesExclusivesShema = new mongoose.Schema({
  titres: {
...
const EnquetesExclusives = mongoose.model('EnquetesExclusives', enquetesExclusivesShema);

export default EnquetesExclusives;
